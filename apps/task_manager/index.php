    ...
    <body>
        ...
        ?>
            <form class="create_task" action="create.php" method="POST">
                ...
                <br/>
                <input type="text" class="task_title_form" placeholder="Title" maxlength="100" name="title">
                <div id="tasks">
                    <input type="hidden" name="notes[]" value="✗">
                    <input type="text" class="task_notes_form" placeholder="Task" maxlength="300" name="notes[]">
